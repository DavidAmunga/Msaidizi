...
public class ClientFinishProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ClientFinishProfile.this, "One more step!", Toast.LENGTH_SHORT).show();

        Paper.init(this);

        Client client = Paper.book().read("currentUser");
    ...
    public void onViewClicked() {
        ...
        if (!TextUtils.isEmpty(bio) && mImageUri != null) {
            final SpotsDialog waitingDialog = new SpotsDialog(ClientFinishProfile.this);
            waitingDialog.show();
            ...
            filepath.putFile(mImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    ...
                    DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Client").child(userId);
                    ref.child("userBio").setValue(bio);
                    ref.child("userImage").setValue(imageUrl);


                    Toast.makeText(ClientFinishProfile.this, "Success!", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(ClientFinishProfile.this, ClientHome.class));
                    finish();
                ...
                public void onFailure(@NonNull Exception e) {
                    waitingDialog.dismiss();
                    Toast.makeText(ClientFinishProfile.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                }
            });
